        ...
        private IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (var i = 0; i < lineCount; i++)
                {
                    ...
                    var rotation = Quaternion.Euler(x: 0, y: 0,
                        Random.Range(minInclusive: -0.25f, maxInclusive: 0.25f));
                    ...
                    for (var j = first; j <= last; j++)
                    {
                        ...
                        var randomScale = Random.Range(minInclusive: 0.95f, maxInclusive: 1.05f);
