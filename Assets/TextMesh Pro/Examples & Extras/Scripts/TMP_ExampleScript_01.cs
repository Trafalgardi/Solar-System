...
namespace TMPro.Examples
{
    public class TMP_ExampleScript_01 : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_text.font = Resources.Load<TMP_FontAsset>(path: "Fonts & Materials/Anton SDF");

            // Load a new material preset which was created with the context menu duplicate.
            m_text.fontSharedMaterial = Resources.Load<Material>(path: "Fonts & Materials/Anton SDF - Drop Shadow");
