...
namespace TMPro.Examples
{
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            Debug.Log(message: "OnPointerEnter()");
        ...
        {
            Debug.Log(message: "OnPointerExit()");
        ...
        private void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                var charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextMeshPro, Input.mousePosition,
                    Camera.main, visibleOnly: true);
                    ...
                    (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    var c = new Color32((byte)Random.Range(minInclusive: 0, maxExclusive: 255),
