...
namespace TMPro.Examples
{
    public class SkewTextExample : MonoBehaviour
    {
        ...
        public AnimationCurve VertexCurve = new(new Keyframe(time: 0, value: 0), new Keyframe(time: 0.25f, value: 2.0f),
            new Keyframe(time: 0.5f, value: 0), new Keyframe(time: 0.75f, value: 2.0f),
            new Keyframe(time: 1, value: 0f));
            ...
            while (true)
            {
                ...
                for (var i = 0; i < characterCount; i++)
                {
                    ...
                    var bottomShear =
                        new Vector3(
                            shear_value *
                            (textInfo.characterInfo[i].baseLine - textInfo.characterInfo[i].bottomRight.y), y: 0, z: 0);
                    ...
                    var horizontal = new Vector3(x: 1, y: 0, z: 0);
                    ...
                    matrix = Matrix4x4.TRS(new Vector3(x: 0, y0, z: 0), Quaternion.Euler(x: 0, y: 0, angle),
                        Vector3.one);
