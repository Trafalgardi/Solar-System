        ...
        private void LateUpdate()
        {
            if (isHoveringObject)
            {
                    ...
                    (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    var c = new Color32(r: 255, g: 255, b: 192, a: 255);
                ...
                // Clear previous word selection.
                if (m_TextPopup_RectTransform != null &&
                    m_selectedWord != -1 &&
                    (wordIndex == -1 || wordIndex != m_selectedWord))
                {
                    ...
                    for (var i = 0; i < wInfo.characterCount; i++)
                    {
                        ...
                        var c = vertexColors[vertexIndex + 0].Tint(tint: 1.33333f);
                    ...
                    !(Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    for (var i = 0; i < wInfo.characterCount; i++)
                    {
                        ...
                        var c = vertexColors[vertexIndex + 0].Tint(tint: 0.75f);
