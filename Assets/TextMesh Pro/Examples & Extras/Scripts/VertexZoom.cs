        ...
        private IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (var i = 0; i < characterCount; i++)
                {
                    ...
                    var randomScale = Random.Range(minInclusive: 1f, maxInclusive: 1.5f);
                    ...
                    matrix = Matrix4x4.TRS(new Vector3(x: 0, y: 0, z: 0), Quaternion.identity,
                ...
                for (var i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    textInfo.meshInfo[i].mesh.SetUVs(channel: 0, textInfo.meshInfo[i].uvs0);
