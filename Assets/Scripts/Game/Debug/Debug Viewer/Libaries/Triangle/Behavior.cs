    ...
    internal class Behavior
    {
        ...
        private void Update()
        {
            ...
            if (minAngle < 0 || minAngle > 60)
            {
                ...
                Log.Instance.Warning(message: "Invalid quality option (minimum angle).", info: "Mesh.Behavior");
            }
            ...
            if (maxAngle != 0.0 && (maxAngle < 60 || maxAngle > 180))
            {
                ...
                Log.Instance.Warning(message: "Invalid quality option (maximum angle).", info: "Mesh.Behavior");
            }
