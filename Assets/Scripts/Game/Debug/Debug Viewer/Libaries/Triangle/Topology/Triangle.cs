...
namespace TriangleNet.Topology
{
    ...
    public class Triangle : ITriangle
    {
        ...
        public override string ToString() => string.Format(format: "TID {0}", hash);
        ...
        public int GetVertexID(int index) => vertices[index].id;
        ...
        public ITriangle GetNeighbor(int index)
            => neighbors[index].tri.hash == Mesh.DUMMY ? null : neighbors[index].tri;

        /// <inheritdoc />
        public int GetNeighborID(int index) => neighbors[index].tri.hash == Mesh.DUMMY ? -1 : neighbors[index].tri.id;
        ...
        public ISegment GetSegment(int index) => subsegs[index].seg.hash == Mesh.DUMMY ? null : subsegs[index].seg;
