...
namespace TriangleNet.Geometry
{
    public static class ExtensionMethods
    {
        ...
        public static IMesh Triangulate(this IPolygon polygon)
            => new GenericMesher().Triangulate(polygon, options: null, quality: null);
        ...
        public static IMesh Triangulate(this IPolygon polygon, ConstraintOptions options)
            => new GenericMesher().Triangulate(polygon, options, quality: null);
        ...
        public static IMesh Triangulate(this IPolygon polygon, QualityOptions quality)
            => new GenericMesher().Triangulate(polygon, options: null, quality);
        ...
        public static IMesh Triangulate(this IPolygon polygon, ConstraintOptions options, QualityOptions quality)
            => new GenericMesher().Triangulate(polygon, options, quality);
        ...
        {
            var t0 = triangle.GetVertex(index: 0);
            var t1 = triangle.GetVertex(index: 1);
            var t2 = triangle.GetVertex(index: 2);
